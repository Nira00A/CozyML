...
export default function StandardButton({ padding = "px-4 py-2", textSize = "text-sm", color = "bg-primary hover:bg-green-600", text }: StandardButtonProps) {
  return (
...
export function SecondaryButton({ padding = "px-4 py-2", textColor = "text-primary", textSize = "text-sm", color = "bg-neutral-300 hover:bg-secondaryBackground/80", text }: StandardButtonProps) {
  return (
